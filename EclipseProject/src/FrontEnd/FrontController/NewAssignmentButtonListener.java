...
public class NewAssignmentButtonListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (option == JOptionPane.OK_OPTION) {
			...
			Assignment temp = new Assignment(-1, panel.getCourse().getID(), "path???", name, 0, dueDate); // 0 so the assignment starts as inactive // -1 is ID that will be generated by model 
			...
			params.add(temp);
			DBMessage msg = new DBMessage(0, 0, 3, 2, params); // 3, 2 is assignmentTableNum, addOpNum
